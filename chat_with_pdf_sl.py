...
llm_groq = ChatGroq(
            groq_api_key=groq_api_key, model_name="llama3-70b-8192", # mixtral-8x7b-32768
                         temperature=0.2)
...
async def on_chat_start():
    ...
    EMBEDDING_MODEL_NAME = "cjvt/sloberta-trendi-topics"
    embeddings = HuggingFaceInstructEmbeddings(
        model_name=EMBEDDING_MODEL_NAME,
        model_kwargs={"device": "cuda"},
    )
    # embeddings = OllamaEmbeddings(model="nomic-embed-text") # "mxbai-embed-large"
    ...
    chain = ConversationalRetrievalChain.from_llm(
        # ChatOllama(model="llama3"), # , "llama3:8b-instruct-q8_0", "mixtral:8x7b-instruct-v0.1-q4_K_M"
        llm=llm_groq,
        chain_type="stuff",
